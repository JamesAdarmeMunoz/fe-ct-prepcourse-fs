...
function devolverUltimoElemento(array) {
   ...
   // Tu código:
   var respuesta = array[array.length-1];
   return respuesta;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   var promedio = (total+=i)/resultadosTest.length;
   return promedio;
}
...
function todosIguales(array) {
   ...
   // Tu código:
   var elementIgls = array => array.every((a) => a === array[0]);
   return elementIgls (array);
}
...
function breakStatement(num) {
 ...
 do {
   ...
   nuevoarray.push(num);
   intentos ++;
 } while (intentos < 10 && num != intentos);
 if (num === intentos) {
